...
class Settings:
    def __init__(self, dapr_client):
        ...
        self.open_api_deployment_name = self.__get_environment_variable("OPENAI_API_DEPLOYMENT_NAME")
        self.api_key = self.__get_secret("OPENAI-API-KEY")
        self.open_api_endpoint = self.__get_secret("OPENAI-API-ENDPOINT")
